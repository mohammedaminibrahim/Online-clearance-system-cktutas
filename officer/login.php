...
if(isset($_POST['submit'])){
  ...
  $officerpassword = sterilize($_POST['password']);

if(empty($officerpassword) && empty($officerid)){
  $_SESSION['message'] = "All Fields are required...**";
  $_SESSION['alert'] = "alert alert-warning";
} else {
  $sqlSelectEmail = "SELECT * from officers WHERE officerid = '$officerid'";
...
<body class="d-flex align-items-center min-h-100">
  ...
  <main id="content" role="main" class="flex-grow-1">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-5 col-xl-4 d-none d-lg-flex justify-content-center align-items-center min-vh-lg-100 position-relative bg-success" style="background-image: url(assets/svg/components/wave-pattern-light.svg);">
          <div class="flex-grow-1 p-5">
            ...
            <figure class="text-center">
              ...
              <figcaption class="blockquote-footer blockquote-light">
                <div class="mb-3">
                  <img class="avatar avatar-circle" src="assets/img/officer.jpg" alt="Image Description">
                </div>
        ...
        <?php endif;?>
            ...
            <form action="" method="POST">
              ...
              <div class="mb-4">
                ...
                <input type="text" class="form-control form-control-lg" name="officerid" id="signupModalFormLoginEmail" placeholder="email@site.com" aria-label="email@site.com" required>
              ...
              <div class="mb-4">
                ...
                <div class="input-group input-group-merge" data-hs-validation-validate-class>
                  <input type="officerpassword" class="js-toggle-password form-control form-control-lg" name="password" id="signupModalFormLoginPassword" placeholder="8+ characters required" aria-label="8+ characters required" required minlength="8" data-hs-toggle-password-options='{
              ...
              <div class="d-grid mb-3">
                <button name="submit" type="submit" class="btn btn-success btn-lg">Log in</button>
              </div>
